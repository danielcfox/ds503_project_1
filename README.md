...
## Contribution: Minh-Hang Redetsky:
  ...
  4) Wrote code for the basic implementation (`TaskB.java`) and the optimized implementation (`TaskB_opt.java`).
     Created a writeup for `TaskB.java` and `TaskB_opt.java`
  ...
  I validated the suggestions of ChatGPT by incorporating the code snippet it suggested in my code and run the code to see if it works. If it works, I researched or asked ChatGPT further to understand why it worked, if it didn't worked, I re-inspected the code and run further tests to narrow down the issues.
